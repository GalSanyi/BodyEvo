...
import { tricepsImg } from "../utils/workout";
import Subtitle from "../shared/Subtitle";
import { getTriceps } from "../utils/wokoutDetail";
...
const Triceps = () => {
  ...
  useEffect(() => {
    const fetchExercises = async () => {
      try {
        const response = await getTriceps();
              ...
              <React.Fragment key={index}>
                <Col lg="6" className="pr-5">
                  <div className="mb-4 exercise__img">
                    <img src={tricepsImg[index].filename} alt="exercise" />
                  </div>
                </Col>
